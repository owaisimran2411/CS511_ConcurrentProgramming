...
#define _nstates2	3	/* validate */
#define minseq2	26
#define maxseq2	27
#define _endstate2	2

#define _nstates1	11	/* patriots */
#define minseq1	16
#define maxseq1	25
#define _endstate1	10

#define _nstates0	17	/* jets */
#define minseq0	0
#define maxseq0	15
...
#define Pvalidate	((P2 *)_this)
typedef struct P2 { /* validate */
...
#define Ppatriots	((P1 *)_this)
typedef struct P1 { /* patriots */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pjets	((P0 *)_this)
typedef struct P0 { /* jets */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
