...
#define _nstates3	32	/* :init: */
#define minseq3	46
#define maxseq3	76
#define _endstate3	31

#define _nstates2	10	/* LoadingMachine */
#define minseq2	37
#define maxseq2	45
#define _endstate2	9

#define _nstates1	25	/* FreightTrain */
#define minseq1	13
#define maxseq1	36
#define _endstate1	24

#define _nstates0	14	/* PassengerTrain */
#define minseq0	0
#define maxseq0	12
...
#define PLoadingMachine	((P2 *)_this)
typedef struct P2 { /* LoadingMachine */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PFreightTrain	((P1 *)_this)
typedef struct P1 { /* FreightTrain */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PPassengerTrain	((P0 *)_this)
typedef struct P0 { /* PassengerTrain */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
